        ...
        <div class="col-lg-8">
            ...
            <div class="cart-card mb-3 d-flex align-items-center justify-content-between">
                ...
                <div class="d-flex align-items-center">
                    <img src="product_images/{{ $item->product->image_path }}" class="cart-img me-3" alt="{{ $item->product->name }}">
                    <div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    @csrf
                    <input type="number" class="form-control qty-box me-3" value="{{ $item->quantity }}" min="1" name="quantity">
